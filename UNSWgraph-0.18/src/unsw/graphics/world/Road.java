    ...
    private void makeRoadMesh() {
        ...
        for (int i = 0; i < size(); i++) {
            for (int j = 0; j < segments; j++) {
                ...
                Point3D currPoint = new Point3D(point(t + i).getX(), (epsilon), point(t + i).getY());
                Point3D nextPoint = null;
                if (t + dt >= 1)  nextPoint = new Point3D(point(t + i).getX(), (0 ), point(t + i).getY());
                if (t + dt < 1) nextPoint = new Point3D(point(t + dt + i).getX(), (0 ), point(t + dt + i).getY());
                Point3D prevPoint = null;
                if (t - dt < 0) prevPoint = new Point3D(point(0 + i).getX(), (0 ), point(0 + i).getY());
                if (t - dt >= 0) prevPoint = new Point3D(point(t - dt + i).getX(), (0), point(t - dt + i).getY());
